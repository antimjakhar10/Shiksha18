...
<div className={`streams-grid ${!showAllStreams ? "mobile-limit" : ""}`}>
...
<div className={`streams-grid ${!showAllCourses ? "mobile-limit" : ""}`}>
...
<div className={`streams-grid ${!showAllFacilities ? "mobile-limit" : ""}`}>
...
onChange={(e)=>setNewPlacement({...newPlacement,avgPackage:e.target.value})}
/>

<input
placeholder="Highest Package (LPA)"
value={newPlacement.highestPackage}
onChange={(e)=>setNewPlacement({...newPlacement,highestPackage:e.target.value})}
/>
...
<div className={`streams-grid ${!showAllPlacements ? "mobile-limit" : ""}`}>
