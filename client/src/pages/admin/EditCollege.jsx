...
function EditCollege({ isAdmin = false }) {
  ...
  const fetchCollege = async () => {
    try {
      ...
      setSelectedPlacements((found.placements || []).map((p) => p?.name));
    } catch (err) {
      console.log(err);
    }
  };
                  ...
                  college.images.map((img, index) => (
                    <div key={index} className="gallery-item">
                      ...
                      <button
                        ...
                        onClick={() => {
                          const updatedImages = college.images.filter(
                            (_, i) => i !== index,
                          );
                  ...
                  <div className="stream-actions">
                    <button
                      ...
                      onClick={async () => {
                        ...
                        const avgPackage = prompt(
                          "Average Package",
                          placement.avgPackage || "",
                        );
                        const highestPackage = prompt(
                          "Highest Package",
